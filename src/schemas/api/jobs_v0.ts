...
/** Job kinds accepted by the v0 API. */
...
export const APIJobCreateSchema_v0 = z
    .object({
        ...
        name: z
            .string()
            .optional()
            .describe('Report name (report jobs); defaults to the template name.'),
        ...
        windowTypeId: z
            .string()
            .optional()
            .describe('Auto-takeoff: window type assigned to detected windows.'),
    })
...
export const APIJobSchema_v0 = z
    .object({
        ...
        result: APIJobResultSchema_v0.optional().describe(
            'Present when the job has a result (always for completed sync jobs).'
        ),
        error: z
            .string()
            .optional()
